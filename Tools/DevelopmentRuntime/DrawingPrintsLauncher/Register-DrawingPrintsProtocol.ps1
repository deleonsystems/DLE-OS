...
$launcher = Join-Path $repository (
    'Tools\DevelopmentRuntime\DrawingPrintsLauncher\' +
    'Invoke-DrawingPrintsProtocol.ps1'
)
$powerShell = 'C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe'
$protocolKey = 'HKCU:\Software\Classes\dle-drawing-prints'
...
if ($Unregister) {
    ...
    Write-Output 'Removed current-user dle-drawing-prints registration.'
    exit 0
}
...
Set-Item -LiteralPath $protocolKey -Value 'URL:DLE-OS Assembly Drawing'
New-ItemProperty `
...
Write-Output 'Registered dle-drawing-prints for the current user.'
