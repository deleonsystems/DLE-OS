...
builder.Services.AddSingleton<IAnalysisProvider>(new PolicyAnalysisProvider(new CodexAppServerAnalysisProvider(runtime.StateRoot), new LocalDocumentAnalysisProvider(runtime.StateRoot)));
