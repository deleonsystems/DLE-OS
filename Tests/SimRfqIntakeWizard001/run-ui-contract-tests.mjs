...
for (const prompt of [
  ...
  "How many assemblies are they asking us to quote?", "What is the assembly number?",
...
for (const value of ["NEW_QUOTE_REQUEST", "MATERIAL_AND_LABOR", "PRICE", "LEAD_TIME",
  "Send to RFQ Qualification", "DleOsSession", "/api/sim/rfq-intakes"])
...
console.log("PASS: 27 SIM Intake Wizard UI contract checks.");
