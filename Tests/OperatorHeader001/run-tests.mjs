...
assert.match(styles, /body\[data-view-mode="mobile"\]\[data-workspace-view="dle-home"\] \.dle-dev-secondary-slot>\.dle-environment-badge,[\s\S]*body\[data-view-mode="mobile"\]\[data-workspace-view="dle-home"\] \.dle-dev-secondary-slot>\.dle-dev-toggle \{ width:46px;min-width:46px;height:34px;min-height:34px;padding:4px 5px;display:inline-flex;align-items:center;justify-content:center;text-align:center;box-sizing:border-box \}/);
...
assert.match(styles, /body\[data-view-mode="mobile"\]\[data-workspace-view="operations-center"\] \.dle-dev-secondary-slot>\.dle-environment-badge,[\s\S]*body\[data-view-mode="mobile"\]\[data-workspace-view="operations-center"\] \.dle-dev-secondary-slot>\.dle-dev-toggle \{ width:46px;min-width:46px;height:34px;min-height:34px;padding:4px 5px;display:inline-flex;align-items:center;justify-content:center;text-align:center;box-sizing:border-box \}/);
...
assert.match(styles, /body\[data-view-mode="mobile"\]\[data-workspace-view="invoice-history"\] \.dle-dev-secondary-slot>\.dle-environment-badge,[\s\S]*body\[data-view-mode="mobile"\]\[data-workspace-view="invoice-history"\] \.dle-dev-secondary-slot>\.dle-dev-toggle \{ width:46px;min-width:46px;height:34px;min-height:34px;padding:4px 5px;display:inline-flex;align-items:center;justify-content:center;text-align:center;box-sizing:border-box \}/);
